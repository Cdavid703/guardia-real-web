...
const UNIFORM_ITEMS: UniformItem[] = [
  ...
  { name: 'Puños Negros',        source: 'integrante', note: 'Adquiridos a través de directivas de la corporación' },
  { name: 'Guantes Blancos',     source: 'integrante', note: 'Adquiridos a través de directivas de la corporación' },
